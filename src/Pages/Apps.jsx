        ...
        <div>
          <Container>
              <div className='py-4 md:py-6 lg:py-10'>
                <h2 className='font-bold text-5xl text-[#001931] text-center mb-4'>Our All Applications</h2>
                ...
                <div className='flex justify-between items-center my-10'>
                    <h3 className='font-semibold text-2xl text-[#001931]'>({searchedApps.length}) Apps Found</h3>
