    ...
    return (
          <div className='bg-linear-to-b from-[#632EE3] to-[#9F62F2] p-20 space-y-10 w-full '>
                ...
                <div className='grid grid-cols-1  lg:grid-cols-3 place-items-center'>
                    <div className='flex flex-col lg:flex-row items-center  text-center mb-5 lg:mb-0  space-x-4 '>
                        <div className='text-center space-y-5'>
                        <p className='text-white'>Total Downloads</p>
                        <h3 className='text-2xl md:text-4xl lg:text-6xl font-extrabold text-white'>29.6M</h3>
                        <p className='text-white'>21% more than last month</p>
                        </div>
                        
                     <FaDownload className='text-white w-5 md:w-6 lg:w-10 h-5 md:h-6 lg:h-10'/>
                   ...
                   <div className='flex flex-col lg:flex-row items-center text-center mb-5 lg:mb-0  space-x-4  '>
                     <div className='text-center space-y-2  lg:space-y-5'>
                        ...
                        <h3 className='text-2xl md:text-4xl lg:text-6xl font-extrabold text-white'>906K</h3>
                        <p className='text-white'>46% more than last month</p>
                    </div>
                    <FaStar className='text-white w-5 md:w-6 lg:w-10 h-5 md:h-6 lg:h-10 mt-2 lg:mt-0'/> 
                   </div>
                   <div className='flex flex-col lg:flex-row items-center text-center mb-5 lg:mb-0  space-x-4  '>
                     <div className='text-center space-y-2  lg:space-y-5'>
                        <p className='text-white'>Active Apps</p>
                        <h3 className='text-2xl md:text-4xl lg:text-6xl font-extrabold text-white'>132+</h3>
                        <p className='text-white'>31 more will Launch</p>
                       
                    </div>
                    <FaGooglePlay className='text-white w-5 md:w-6 lg:w-10 h-5 md:h-6 lg:h-10 mt-2 lg:mt-0'/>
